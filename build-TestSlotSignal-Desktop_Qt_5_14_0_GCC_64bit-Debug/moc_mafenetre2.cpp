/****************************************************************************
** Meta object code from reading C++ file 'mafenetre2.h'
**
...
#include <memory>
#include "../TestSlotSignal/mafenetre2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'mafenetre2.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 27, 15) // "changerLongueur"

    },
    "MaFenetre2\0changerLargeur\0\0changerLongueur"
};
...
void MaFenetre2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MaFenetre2 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changerLargeur((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->changerLongueur((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject MaFenetre2::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MaFenetre2.data,
    qt_meta_data_MaFenetre2,
    qt_static_metacall,
    nullptr,
    nullptr
} };
